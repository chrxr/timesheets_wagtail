...
def projectsView(request):
    ...
    date_to_filter = request.GET.get('date-to', '')
    date_from_filter = request.GET.get('date-from', '')
    ...
    for project in projects:
        ...
        if times:
            ...
            all_projects[project.projectName] = {'times':times, 'total_time':total_time}

    filters = [{"label": "Project","name": "project", "options": filter_list}]

    return render(request, 'app/viewprojects.html', {'projects': all_projects, 'filters': filters})
